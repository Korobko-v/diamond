...
public class DiamondApp {
    ...
    private static boolean isLattice(int width, int height, int position, int lineNumber) {
        ...
        if (lineNumber > 0 && lineNumber < height - 1) {
            ...
            В случае, если ширина строки в 2 и более раз меньше высоты, для всех строк, отстающих от ближайшего края (верх/низ) более, чем на
            величину, равную частному номера строки и ширины ромба (с округлением в большую сторону), отклонение будет равно половине ширины, и
            решётки будут расположены по краям.
